...
const MOCK_CASES_BY_ID = {
  ...
  'mock-008': {
    ...
    activity: [
      ...
      { id: 'a2', created_at: '2026-03-24T09:01:00Z', action: 'Bestätigungs-E-Mail gesendet', actor: 'system', detail: 'An k.petersen@kp-management.de' },
    ],
    messages: [
      { id: 'm1', created_at: '2026-03-24T09:01:00Z', type: 'email_out', subject: 'Ihre Anfrage bei Rise Legal — Eingangsbestätigung', body: 'Sehr geehrter Herr Petersen,\n\nwir haben Ihre Anfrage erhalten und werden uns in Kürze bei Ihnen melden.\n\nMit freundlichen Grüßen\nRise Legal', from: 'kontakt@rise-legal.de', to: 'k.petersen@kp-management.de' },
    ],
  },
}

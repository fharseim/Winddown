...
const MOCK_CASES_BY_ID = {
  ...
  'mock-007': {
    case: {
      ...
      firma_rechtsform: 'UG',
      firma_gruendungsjahr: null,
      firma_sitz: 'Strande',
      hrb_nummer: 'HRB 27148',
      registergericht: 'AG Kiel',
      hr_validated: false,
      operativ_aktiv: null,
      operativ_inaktiv_seit: '',
      mitarbeiter: false,
      mitarbeiter_anzahl: 0,
      glaeubiger: 'unbekannt',
      jahresabschluesse_aktuell: null,
      rueckstand_jahre: 0,
      steuerberater: false,
      gesellschafter_anzahl: '',
      vsop_esop: 'nein',
      investoren: false,
      investoren_typ: '',
      vermoegensfrei: 'unbekannt',
      satzung_filename: null,
      calculated_fee: null,
      internal_notes: '',
    },
    documents: [],
    activity: [
      { id: 'a1', created_at: '2026-03-24T08:00:00Z', action: 'Intake-Formular eingereicht', actor: 'system', detail: 'Via Website — Formular vollständig ausgefüllt' },
      { id: 'a2', created_at: '2026-03-24T08:01:00Z', action: 'Bestätigungs-E-Mail gesendet', actor: 'system', detail: 'An j.schmidt@amplius-cleantech.de' },
    ],
    messages: [
      { id: 'm1', created_at: '2026-03-24T08:01:00Z', type: 'email_out', subject: 'Ihre Anfrage bei Rise Legal — Eingangsbestätigung', body: 'Sehr geehrter Herr Schmidt,\n\nwir haben Ihre Anfrage erhalten und werden uns in Kürze bei Ihnen melden.\n\nMit freundlichen Grüßen\nRise Legal', from: 'kontakt@rise-legal.de', to: 'j.schmidt@amplius-cleantech.de' },
    ],
  },
  'mock-008': {
    case: {
      ...
      firma_rechtsform: 'UG',
      firma_gruendungsjahr: 2022,
      firma_sitz: 'Kiel',
      hrb_nummer: 'HRB 25133',
      registergericht: 'AG Kiel',
      hr_validated: false,
      operativ_aktiv: null,
      operativ_inaktiv_seit: '',
    ...
    documents: [],
    activity: [
      { id: 'a1', created_at: '2026-03-24T09:00:00Z', action: 'Intake-Formular eingereicht', actor: 'system', detail: 'Via Website — Formular vollständig ausgefüllt' },
      { id: 'a2', created_at: '2026-03-24T09:01:00Z', action: 'Bestätigungs-E-Mail gesendet', actor: 'system', detail: 'An p.kohlhoff@kp-management.de' },
    ],
    messages: [
      { id: 'm1', created_at: '2026-03-24T09:01:00Z', type: 'email_out', subject: 'Ihre Anfrage bei Rise Legal — Eingangsbestätigung', body: 'Sehr geehrter Herr Kohlhoff,\n\nwir haben Ihre Anfrage erhalten und werden uns in Kürze bei Ihnen melden.\n\nMit freundlichen Grüßen\nRise Legal', from: 'kontakt@rise-legal.de', to: 'p.kohlhoff@kp-management.de' },
    ],
  },
}
